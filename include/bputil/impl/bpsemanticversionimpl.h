...
#ifndef BPSEMANTICVERSIONIMPL_H_
#define BPSEMANTICVERSIONIMPL_H_
...
inline int
SemanticVersion::majorVer() const
{
    return m_major;
}
...
inline void
SemanticVersion::setMajor(int major)
{
    m_major = major;
}
...
inline int
SemanticVersion::minorVer() const
{
    return m_minor;
}
...
inline void
SemanticVersion::setMinor(int minor)
{
    m_minor = minor;
}
...
inline int
SemanticVersion::microVer() const
{
    return m_micro;
}
...
inline void
SemanticVersion::setMicro(int micro)
{
    m_micro = micro;
}
...
inline void
SemanticVersion::setNano(int nano)
{
    m_nano = nano;
}
...
inline bool
SemanticVersion::match(const SemanticVersion& other) const
{
...
inline bool 
SemanticVersion::withinRange(const SemanticVersion& vmin,
...
inline bool
SemanticVersion::parse(const char* version)
{
...
inline bool
SemanticVersion::parse(const std::string& version)
{
...
inline std::string
SemanticVersion::asString(void) const
{
...
inline bool
SemanticVersion::isNewerMatch(const SemanticVersion& current,
...
#endif // BPSEMANTICVERSIONIMPL_H_
